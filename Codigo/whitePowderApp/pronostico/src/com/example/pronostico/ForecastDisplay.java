...
public class ForecastDisplay extends AsyncTask<Double, Void, Void> {
	...
	protected Void doInBackground(Double...coordenadas) {
		...
		URL url;
		try {
		url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?lat="+coordenadas[0].toString()+"&lon="+coordenadas[1].toString()+"&units=metric&cnt=7&APPID=6a4c7323eb6848f9d7ac4224402ed312");
